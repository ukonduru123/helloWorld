...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'ukonduru', 'email': 'ukonduru@umd.edu', 'first_name': 'Unnathi', 'last_name': 'Konduru',
         'password': generate_password_hash('unnathipw', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
