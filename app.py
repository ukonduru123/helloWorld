...
@role_required(['ADMIN', 'MANAGER'])
def training():
    # Display training webpage to authorized users

    # I will be training, so I will pull my information
    trainer = User.query.filter_by(first_name='Unnathi', last_name='Konduru').first()
    if trainer:
